...
class SimpleMapTest {
    ...
    void whenCheckGetNullAndZero() {
        SimpleMap<Integer, String> map = new SimpleMap<>();
        assertThat(map.put(0, "3")).isTrue();
        assertThat(map.get(null)).isNull();
    }

    @Test
    void whenCheckPutNullAnd16AndFalseBecauseCollision() {
        SimpleMap<Integer, String> map = new SimpleMap<>();
        assertThat(map.put(null, "0000")).isTrue();
        assertThat(map.put(16, "0")).isFalse();
        assertThat(map.get(null)).isEqualTo("0000");
    }

    @Test
    void whenCheckRemoveThenPutAndGet() {
        SimpleMap<Integer, String> map = new SimpleMap<>();
        assertThat(map.put(null, "0000")).isTrue();
        assertThat(map.put(16, "0")).isFalse();
        assertThat(map.remove(null)).isTrue();
        assertThat(map.put(16, "0")).isTrue();
        assertThat(map.get(null)).isNull();
        assertThat(map.get(16)).isEqualTo("0");
    }
}